...
//lpm_compare DEVICE_FAMILY="Cyclone III" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=4 ONE_INPUT_IS_CONSTANT="YES" alb dataa datab
...
module IsDigit (
	...
	IsDigit_cmpr	IsDigit_cmpr_component (
				.dataa (dataa),
				.datab (sub_wire1),
				.alb (sub_wire0));

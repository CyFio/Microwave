...
//lpm_compare DEVICE_FAMILY="Cyclone III" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=4 alb dataa datab
...
module ALessThanB4bit (
	...
	ALessThanB4bit_cmpr	ALessThanB4bit_cmpr_component (
				.dataa (dataa),
				.datab (datab),
				.alb (sub_wire0));

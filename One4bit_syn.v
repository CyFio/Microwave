...
//lpm_constant ENABLE_RUNTIME_MOD="NO" LPM_CVALUE=1 LPM_WIDTH=4 result
...
module  One4bit_lpm_constant
	...
	assign
		result = 4'b0001;
endmodule //One4bit_lpm_constant
//VALID FILE
...
module One4bit (
	...
	One4bit_lpm_constant	One4bit_lpm_constant_component (
				.result (sub_wire0));

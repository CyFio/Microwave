...
//lpm_constant ENABLE_RUNTIME_MOD="NO" LPM_CVALUE=8 LPM_WIDTH=4 result
...
module  Eight4bit_lpm_constant
	...
	assign
		result = 4'b1000;
endmodule //Eight4bit_lpm_constant
//VALID FILE
...
module Eight4bit (
	...
	Eight4bit_lpm_constant	Eight4bit_lpm_constant_component (
				.result (sub_wire0));

...
//lpm_constant ENABLE_RUNTIME_MOD="NO" LPM_CVALUE=0 LPM_WIDTH=4 result
...
module  Zero4bit_lpm_constant
	...
	assign
		result = {4{1'b0}};
endmodule //Zero4bit_lpm_constant
//VALID FILE
...
module Zero4bit (
	...
	Zero4bit_lpm_constant	Zero4bit_lpm_constant_component (
				.result (sub_wire0));
